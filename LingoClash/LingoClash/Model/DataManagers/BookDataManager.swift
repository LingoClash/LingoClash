...
class BookDataManager {
    ...
    init(dataProvider: FirebaseDataProvider = FirebaseDataProvider()) {
    ...
    func getList(
        ...
        var booksInfo = [Book(books_category_id: "1", name: "")]
        dataProvider.getList(resource: self.resource, params: GetListParams(pagination: pagination, sort: sort, filter: filter)) { myBooksInfo, err in
                booksInfo = myBooksInfo
        }
